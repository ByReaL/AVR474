...
void FillResponseStr(char const * source)
{
...
{
  FillResponseStr(str_MfrName);			//! \todo  Modify as needed. const char defined in smbus.h
  return 0;
}
...
{
  FillResponseStr(str_DeviceName);		//! \todo  Modify as needed. const char defined in smbus.h
  return 0;
}
...
{
  FillResponseStr(str_DeviceChem);		//! \todo  Modify as needed. const char defined in smbus.h
  return 0;
}
...
{
  FillResponseStr(str_MfrData);			//! \todo  Modify as needed. const char defined in smbus.h
  return 0;
}
...
const uint8_t crctable[16] PROGMEM =  {0,0x07,0x0E,0x90, 0x1c,0x1b,0x12,0x15, 0x38,0x3F,0x36,0x31, 0x24,0x23,0x2A,0x2D};
const uint8_t crctable2[16] PROGMEM = {0,0x70,0xE0,0x09, 0xC1,0xB1,0x21,0x51, 0x83,0xF3,0x63,0x13, 0x42,0x32,0xA2,0xD2};
