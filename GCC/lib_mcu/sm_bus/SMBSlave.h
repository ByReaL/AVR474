...
#define SMBvar_int   SV.SMBint
  ...
  const char str_MfrName[]    PROGMEM = "\014Atmel Norway"; //const char
  const char str_DeviceName[] PROGMEM = "\005SB100";
  const char str_DeviceChem[] PROGMEM = "\004LION";
  const char str_MfrData[]    PROGMEM = "\013MfrDataArea";
